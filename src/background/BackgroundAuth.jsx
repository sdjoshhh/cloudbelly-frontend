const BackgroundAuth = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 -right-24 h-80 w-80 rounded-full bg-teal-300/25 blur-3xl" />
      <div className="absolute bottom-[-40px] left-1/3 h-72 w-72 rounded-full bg-violet-300/20 blur-3xl" />
